    ...
    <div class="card-body">
        <form action="{{ route('samples.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="client_organization" class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="sample_matrix" class="form-control" placeholder="Water, Soil, Air">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="sampling_date" class="form-control" value="{{ date('Y-m-d') }}" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="sampling_method" class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="preservation_method" class="form-control">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" name="received_time" class="form-control">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <input type="number" step="any" name="sample_quantity" class="form-control">
                            </div>
                            <div class="col-4">
                                <input type="text" name="quantity_unit" class="form-control" placeholder="Unit">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="sample_description" class="form-control" rows="2"></textarea>
            </div>
            <div class="mb-3">
